...
| `65-maths` | The maths pages' worked examples are the tests: each lab set to the example's setup must reproduce the page's value (from the equation or the published figure); each covered lab links to its page; each page renders |
