...
(function () {
  ...
  Chrono.MISSIONS = {
    ...
    stars: [
      ...
      { id: "year", title: "In the 25-Sun star, find the first stage that lasts less than a year",
        hint: "One star at 25 Suns: play its life and watch the stages. Neon comes after carbon.",
        check: s => s.mode === "star" && s.mass === 25 && s.stage === 3,
        near: s => s.mode === "star" && s.mass === 25 ? Math.min(1, s.stage / 3) : 0, hold: 600,
        ...
        tags: ["ESTABLISHED"], show: { mode: "star", star: 6, p: 3.2, play: false } },
