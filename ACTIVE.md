...
**3c done** (control hints in Learn mode, mission circles, Try boxes wait for missions; explanation length deferred by Will). **3d-1 done** (Flatland on the lab template; blank-canvas check made real). **Next:** 3d-2 phone pass across all labs (390 px contact sheet; canvas labels off the edge; Atlas 900 px min width + list view on mobile). Stars lab (`src/stars.js`, D-048) fitted in between.
