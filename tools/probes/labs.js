...
window.addEventListener("load", () => setTimeout(async () => {
  ...
  const stepErr = [], arrival = [], unfinished = []; let missions = 0;
  ...
  out.textContent = JSON.stringify({ labs: labs.length, errors: __E, stepErr, missions, arrival, unfinished }); document.body.appendChild(out);
}, 400));
