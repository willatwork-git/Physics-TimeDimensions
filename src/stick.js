...
(function () {
  ...
  const TRAP = {
    ...
    stars: ["The Sun will one day make gold.", "Stars are famous for forging the elements, and gold is famously 'from the stars'.",
      "The Sun will never get past carbon and oxygen. Even the biggest stars stop at iron. Most gold came from colliding neutron stars.", "ESTABLISHED"],
