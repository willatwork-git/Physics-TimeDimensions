...
(function () {
  ...
  Chrono.lab.register({
    ...
    aside: () => `
      ...
      <p><b>Holding entropy isn't keeping it.</b> As a black hole evaporates, its own entropy falls, but the glow it sends out carries more: about one and a half times what the hole held. So evaporation still raises the total. A black hole is a stage in entropy's growth, not where it ends up. <span class="tag ESTABLISHED">Established</span> (theory; unobserved)</p>
      <p><b>Why the universe won't end as one giant black hole.</b> Gravity merges what is bound together: the Milky Way and Andromeda will become one galaxy, and their central black holes will likely merge. But dark energy carries galaxy groups apart faster than gravity can pull them back, so the far future is many lonely black holes, each evaporating in turn, not one. That rests on dark energy staying as it is. If it weakens and turns around, as DESI's hints allow, the story changes. Expansion and entropy together set how the universe ends: try the <b>Heavy: recollapses</b> preset in <a href="#expand">Expanding universe</a>. <span class="tag ESTABLISHED">Established</span> (projection) · <span class="tag CONTESTED">Contested</span> (dark energy's future)</p>
    ...
    sources: "S. W. Hawking, Nature 248, 30 (1974); D. N. Page, Phys. Rev. D 13, 198 (1976) and Phys. Rev. Lett. 71, 3743 (1993); G. Penington, JHEP (2020); A. Almheiri et al., JHEP (2019); J. Steinhauer, Nature Physics 12, 959 (2016); B. Carr et al., Phys. Rev. D 81, 104019 (2010); W. H. Zurek, Phys. Rev. Lett. 49, 1683 (1982); D. N. Page, Phys. Rev. Lett. 50, 1013 (1983); DESI Collaboration, arXiv:2503.14738 (2025)."
  });
  ...
  Chrono.lab.register({
    ...
    next: { q: "Everything after the first few minutes was made in stars. How?", href: "#stars", label: "Cosmos · Stars forge the elements" },
