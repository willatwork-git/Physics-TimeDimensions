  ...
  const PAGES = {
    ...
    arrow: {
      ...
      sections: [
        ...
        ["Entropy climbs; complexity rises and falls", `<p>Low entropy isn't calm — it's stored-up potential. The early universe was a hot, fast-moving soup, but spread almost perfectly evenly, and for gravity evenness is the unspent state. Everything since has been gravity spending it. <span class="tag ESTABLISHED">Established</span></p>
